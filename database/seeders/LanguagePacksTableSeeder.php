    ...
    public function run(): void
    {
        ...
        DB::table('language_packs')->insert([
            ...
            [
                ...
                'lang_values' => '{"en":"Please use \"Password\" or \"Verify Code\" to log in to your account first, and then operate linked in your account settings after logging in.","zh-Hans":"请先使用「密码」或者「验证码」登录账号，登录后在账号设置中绑定关联。","zh-Hant":"請先使用「密碼」或「驗證碼」登入帳號，登入後在帳號設定中綁定關聯。"}',
                'is_custom' => 0,
                'created_at' => '2022-10-18 17:00:00',
                'updated_at' => null,
                'deleted_at' => null,
        ...
        DB::table('language_packs')->insert([
            ...
            [
                'lang_key' => 'editorUploadTipExtensions',
            ...
            [
                'lang_key' => 'editorUploadTipMaxSize',
            ...
            [
                'lang_key' => 'editorUploadTipMaxTime',
            ...
            [
                'lang_key' => 'editorFileWarningDesc',
