...
class CreateUsersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->string('avatar_file_url', 255)->nullable();
            $table->unsignedBigInteger('decorate_file_id')->nullable();
            $table->string('decorate_file_url', 255)->nullable();
            ...
            $table->string('verified_file_url', 255)->nullable();
            $table->string('verified_desc', 255)->nullable();
