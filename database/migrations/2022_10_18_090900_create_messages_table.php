...
class CreateMessagesTable extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('conversations', function (Blueprint $table) {
            ...
            $table->boolean('a_is_display')->default(1);
            $table->boolean('b_is_display')->default(1);
            $table->boolean('a_is_pin')->default(0);
            $table->boolean('b_is_pin')->default(0);
