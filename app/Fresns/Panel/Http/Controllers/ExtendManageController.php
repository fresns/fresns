...
class ExtendManageController extends Controller
{
    public function index()
    {
        ...
        $plugins = $plugins->filter(function ($plugin) {
            return in_array('extendManage', $plugin->scene ?: []);
        });

        $pluginUsages = PluginUsage::type(PluginUsage::TYPE_MANAGE)
            ->orderBy('rating')
            ->with('plugin', 'names')
            ->paginate();
        ...
        return view('FsView::extends.manage', compact('pluginUsages', 'plugins', 'roles'));
    }

    public function store(Request $request)
    {
        $pluginUsage = new PluginUsage;
        $pluginUsage->usage_type = PluginUsage::TYPE_MANAGE;
