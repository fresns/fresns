        ...
        <div class="row mb-4">
            ...
            <div class="col-lg-6">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" name="audio_bucket_name" value="{{ $params['audio_bucket_name'] }}">
                </div>
                <div class="input-group mb-3">
                    <label class="input-group-text w-25">Bucket Region</label>
                    <input type="text" class="form-control" name="audio_bucket_region" value="{{ $params['audio_bucket_region'] }}">
                </div>
                <div class="input-group mb-3">
                    <label class="input-group-text w-25">Bucket Endpoint</label>
                    <input type="text" class="form-control" name="audio_bucket_endpoint" value="{{ $params['audio_bucket_endpoint'] }}">
                </div>
                <div class="input-group mb-3">
                    <label class="input-group-text w-25">{{ __('FsLang::panel.storage_file_access_domain') }}</label>
                    <input type="text" class="form-control" name="audio_access_domain" value="{{ $params['audio_access_domain'] }}">
                </div>
                <div class="input-group mb-3">
        ...
        <div class="row mb-4">
            ...
            <div class="col-lg-6">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="number" class="form-control" id="audio_max_duration" name="audio_max_duration" value="{{ $params['audio_max_duration'] }}">
                ...
                <div class="input-group mb-3">
                    ...
                    <div class="form-control bg-white">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="audio_temporary_url_status" id="audio_temporary_url_status_false" value="false" data-bs-toggle="collapse" data-bs-target=".audio_temporary_url_status_setting.show" aria-expanded="false" aria-controls="audio_temporary_url_status_setting" {{ !$params['audio_temporary_url_status'] ? 'checked' : '' }}>
                            <label class="form-check-label" for="audio_temporary_url_status_false">{{ __('FsLang::panel.option_close') }}</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="audio_temporary_url_status" id="audio_temporary_url_status_true" value="true" data-bs-toggle="collapse" data-bs-target=".audio_temporary_url_status_setting:not(.show)" aria-expanded="false" aria-controls="audio_temporary_url_status_setting" {{ $params['audio_temporary_url_status'] ? 'checked' : '' }}>
                            <label class="form-check-label" for="audio_temporary_url_status_true">{{ __('FsLang::panel.option_open') }}</label>
                        </div>
                    </div>
                </div>
                <!--temporary url-->
                <div class="collapse audio_temporary_url_status_setting {{ $params['audio_temporary_url_status'] ? 'show' : '' }}">
                    <div class="input-group mb-3">
                        <label class="input-group-text w-25">{{ __('FsLang::panel.storage_temporary_url_key') }}</label>
                        <input type="text" class="form-control" id="audio_temporary_url_key" name="audio_temporary_url_key" value="{{ $params['audio_temporary_url_key'] }}">
                    </div>
                    <div class="input-group mb-3">
                        <label class="input-group-text">{{ __('FsLang::panel.storage_temporary_url_expiration') }}</label>
                        <input type="number" class="form-control" id="audio_temporary_url_expiration" name="audio_temporary_url_expiration" value="{{ $params['audio_temporary_url_expiration'] }}">
