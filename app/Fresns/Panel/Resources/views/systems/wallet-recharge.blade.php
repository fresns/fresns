...
@section('content')
    ...
    <div class="row mb-4">
        <div class="col-lg-7">
            ...
            <p class="text-secondary">{{ __('FsLang::panel.sidebar_wallet_tab_recharge_services_intro') }}</p>
        </div>
        <div class="col-lg-5">
            <div class="input-group mt-2 mb-4 justify-content-lg-end">
                <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#editModal" data-action="{{ route('panel.app-usages.store', ['usageType' => 'wallet-recharge']) }}">
        ...
        <ul class="nav nav-tabs">
            ...
            <li class="nav-item"><a class="nav-link active" href="{{ route('panel.app-usages.index', ['usageType' => 'wallet-recharge']) }}">{{ __('FsLang::panel.sidebar_wallet_tab_recharge_services') }}</a></li>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">{{ __('FsLang::panel.sidebar_wallet_tab_recharge_services') }}</h5>
