...
@section('content')
    ...
    <div class="row mb-4 border-bottom">
        <div class="col-lg-9">
            <h3>{{ __('FsLang::panel.sidebar_extend_user_feature') }}</h3>
            <p class="text-secondary">{{ __('FsLang::panel.sidebar_extend_user_feature_intro') }}</p>
        </div>
        <div class="col-lg-3">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">{{ __('FsLang::panel.sidebar_extend_user_feature') }}</h5>
