...
@section('content')
    ...
    <div class="row mb-4 border-bottom">
        <div class="col-lg-9">
            ...
            <p class="text-secondary">{{ __('FsLang::panel.sidebar_extend_channel_intro') }}</p>
        </div>
        <div class="col-lg-3">
            <div class="input-group mt-2 mb-4 justify-content-lg-end">
                <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#editModal" data-action="{{ route('panel.app-usages.store', ['usageType' => 'channel']) }}">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">{{ __('FsLang::panel.sidebar_extend_channel') }}</h5>
