    ...
    <div class="row mb-4 border-bottom">
        ...
        <div class="col-lg-3">
            <div class="input-group mt-2 mb-4 justify-content-lg-end">
                <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#editModal" data-action="{{ route('panel.app-usages.store', ['usageType' => 'manage']) }}">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @if (in_array(3, explode(',', $item->scene)))
                                <span class="badge bg-light text-dark">{{ __('FsLang::panel.user') }}</span>
                            @endif
                        </td>
                        <td>
