...
@section('content')
    ...
    <!--form-->
    <form action="{{ route('panel.roles.permissions.update', $role->id) }}" id="rolePermission" method="post">
        @csrf
        @method('put')
                    ...
                    <div class="form-control bg-white">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio"
                                {{ !($permission['post_limit_status']['permValue'] ?? '') ? 'checked' : '' }}
                                name="permission[post_limit_status]" id="post.limit.status.0" value="0"
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio"
                                {{ $permission['post_limit_status']['permValue'] ?? '' ? 'checked' : '' }}
                                name="permission[post_limit_status]" id="post.limit.status.1" value="1"
                ...
                <div class="collapse {{ $permission['post_limit_status']['permValue'] ?? false ? 'show' : '' }}" id="post_limit_setting">
                    <div class="input-group mb-3">
                        ...
                        <select class="form-select" id="post_limit_type" name="permission[post_limit_type]">
                            <option value="1" id="post_datetime" {{ ($permission['post_limit_type']['permValue'] ?? '') == 1 ? 'selected' : '' }}>{{ __('FsLang::panel.permission_option_rule_datetime') }}</option>
                            <option value="2" id="post_time" {{ ($permission['post_limit_type']['permValue'] ?? '') == 2 ? 'selected' : '' }}>{{ __('FsLang::panel.permission_option_rule_time') }}</option>
                        </select>
                    </div>
                    <div class="input-group mb-3 collapse {{ $permission['post_limit_type']['permValue'] == 1 ? 'show' : '' }}" id="post_datetime_setting">
                        <label class="input-group-text">{{ __('FsLang::panel.publish_rule_datetime') }}</label>
                        <input type="datetime-local" class="form-control" value="{{ $permission['post_limit_period_start']['permValue'] ?? '' }}" name="permission[post_limit_period_start]" placeholder="2022/01/01 22:00:00">
                        <input type="datetime-local" class="form-control" value="{{ $permission['post_limit_period_end']['permValue'] ?? '' }}" name="permission[post_limit_period_end]" placeholder="2022/01/05 09:00:00">
                    </div>
                    <div class="input-group mb-3 collapse {{ $permission['post_limit_type']['permValue'] == 2 ? 'show' : '' }}" id="post_time_setting">
                        <label class="input-group-text">{{ __('FsLang::panel.publish_rule_time') }}</label>
                        <input type="time" class="form-control" value="{{ $permission['post_limit_cycle_start']['permValue'] ?? '' }}" name="permission[post_limit_cycle_start]" placeholder="22:00:00">
                        <input type="time" class="form-control" value="{{ $permission['post_limit_cycle_end']['permValue'] ?? '' }}" name="permission[post_limit_cycle_end]" placeholder="09:00:00">
                    </div>
                    <div class="input-group mb-3">
            ...
            <div class="col-lg-6">
                ...
                <div class="input-group mb-3">
                    ...
                    <div class="form-control bg-white">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio"
                                {{ !($permission['comment_limit_status']['permValue'] ?? '') ? 'checked' : '' }}
                                name="permission[comment_limit_status]" id="comment.limit.status.0" value="0"
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio"
                                {{ $permission['comment_limit_status']['permValue'] ?? '' ? 'checked' : '' }}
                                name="permission[comment_limit_status]" id="comment.limit.status.1" value="1"
                ...
                <div class="collapse  {{ $permission['comment_limit_status']['permValue'] ?? false ? 'show' : '' }}" id="comment_limit_setting">
                    <div class="input-group mb-3">
                        ...
                        <select class="form-select" id="comment_limit_type" name="permission[comment_limit_type]">
                            <option value="1" id="comment_datetime" {{ ($permission['comment_limit_type']['permValue'] ?? '') == 1 ? 'selected' : '' }}>{{ __('FsLang::panel.permission_option_rule_datetime') }}</option>
                            <option value="2" id="comment_time" {{ ($permission['comment_limit_type']['permValue'] ?? '') == 2 ? 'selected' : '' }}>{{ __('FsLang::panel.permission_option_rule_time') }}</option>
                        </select>
                    </div>
                    <div class="input-group mb-3 collapse {{ ($permission['comment_limit_type']['permValue'] ?? '') == 1 ? 'show' : '' }}" id="comment_datetime_setting">
                        <label class="input-group-text">{{ __('FsLang::panel.publish_rule_datetime') }}</label>
                        <input type="datetime-local" class="form-control" value="{{ $permission['comment_limit_period_start']['permValue'] ?? '' }}" name="permission[comment_limit_period_start]" placeholder="2022/01/01 22:00:00">
                        <input type="datetime-local" class="form-control" value="{{ $permission['comment_limit_period_end']['permValue'] ?? '' }}" name="permission[comment_limit_period_end]" placeholder="2022/01/05 09:00:00">
                    </div>
                    <div class="input-group mb-3 collapse {{ ($permission['comment_limit_type']['permValue'] ?? '') == 2 ? 'show' : '' }}" id="comment_time_setting">
                        <label class="input-group-text">{{ __('FsLang::panel.publish_rule_time') }}</label>
                        <input type="time" class="form-control" value="{{ $permission['comment_limit_cycle_start']['permValue'] ?? '' }}" name="permission[comment_limit_cycle_start]" placeholder="22:00:00">
                        <input type="time" class="form-control" value="{{ $permission['comment_limit_cycle_end']['permValue'] ?? '' }}" name="permission[comment_limit_cycle_end]" placeholder="09:00:00">
                    </div>
                    <div class="input-group mb-3">
                        <label class="input-group-text">{{ __('FsLang::panel.publish_rule_rule') }}</label>
                        <div class="form-control bg-white">
        ...
        <div class="row mb-4">
            ...
            <div class="col-lg-10">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="number" class="form-control input-number" value="{{ $permission['image_max_size']['permValue'] ?? '' }}" value="1" name="permission[image_max_size]" placeholder="{{ __('FsLang::panel.storage_max_size') }}">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="number" class="form-control input-number" value="{{ $permission['video_max_size']['permValue'] ?? '' }}" value="1" name="permission[video_max_size]" placeholder="{{ __('FsLang::panel.storage_max_size') }}">
                    <span class="input-group-text">MB</span>
                    <input type="number" class="form-control input-number" value="{{ $permission['video_max_time']['permValue'] ?? '' }}" value="1" name="permission[video_max_time]" placeholder="{{ __('FsLang::panel.storage_max_time') }}">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="number" class="form-control input-number" value="{{ $permission['audio_max_size']['permValue'] ?? '' }}" value="1" name="permission[audio_max_size]" placeholder="{{ __('FsLang::panel.storage_max_size') }}">
                    <span class="input-group-text">MB</span>
                    <input type="number" class="form-control input-number" value="{{ $permission['audio_max_time']['permValue'] ?? '' }}" value="1" name="permission[audio_max_time]" placeholder="{{ __('FsLang::panel.storage_max_time') }}">
                    <span class="input-group-text">{{ __('FsLang::panel.unit_second') }}</span>
                </div>
                <!--document-->
                <div class="input-group mb-3">
                    ...
                    <div class="input-group-text">
                        <input class="form-check-input mt-0" type="checkbox" {{ $permission['post_editor_document']['permValue'] ?? '' ? 'checked' : '' }} value="1" name="permission[post_editor_document]" id="post_editor_document" value="0">
                        <label class="form-check-label ms-1" for="post_editor_document">{{ __('FsLang::panel.post') }}</label>
                    </div>
                    <div class="input-group-text">
                        <input class="form-check-input mt-0" type="checkbox" {{ $permission['comment_editor_document']['permValue'] ?? '' ? 'checked' : '' }} value="1" name="permission[comment_editor_document]" id="comment_editor_document" value="0">
                        <label class="form-check-label ms-1" for="comment_editor_document">{{ __('FsLang::panel.comment') }}</label>
                    </div>
                    <input type="number" class="form-control input-number" value="{{ $permission['document_max_size']['permValue'] ?? '' }}" value="1" name="permission[document_max_size]" placeholder="{{ __('FsLang::panel.storage_max_size') }}">
                    <span class="input-group-text">MB</span>
                </div>
