...
@section('content')
    ...
    <div class="row mb-4 border-bottom">
        <div class="col-lg-9">
            <h3>{{ __('FsLang::panel.sidebar_expand_user_profile') }}</h3>
            <p class="text-secondary">{{ __('FsLang::panel.sidebar_expand_user_profile_intro') }}</p>
        </div>
        <div class="col-lg-3">
        ...
        <table class="table table-hover align-middle text-nowrap">
            ...
            <tbody>
                @foreach ($pluginUsages as $item)
                    <tr>
                        <td><input type="number" data-action="{{ route('panel.user-profile.rank', $item->id) }}" class="form-control input-number rank-num" value="{{ $item['rank_num'] }}"></td>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">{{ __('FsLang::panel.sidebar_expand_user_profile') }}</h5>
