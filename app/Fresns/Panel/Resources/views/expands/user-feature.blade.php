...
@section('content')
    ...
    <div class="row mb-4 border-bottom">
        <div class="col-lg-9">
            <h3>{{ __('FsLang::panel.sidebar_expand_user_feature') }}</h3>
            <p class="text-secondary">{{ __('FsLang::panel.sidebar_expand_user_feature_intro') }}</p>
        </div>
        <div class="col-lg-3">
            <div class="input-group mt-2 mb-4 justify-content-lg-end">
                <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-action="{{ route('panel.user-feature.store') }}" data-bs-target="#configModal">
        ...
        <table class="table table-hover align-middle text-nowrap">
            ...
            <tbody>
                @foreach ($pluginUsages as $item)
                    <tr>
                        <td><input type="number" data-action="{{ route('panel.user-feature.rank', $item->id) }}" class="form-control input-number rank-num" value="{{ $item['rank_num'] }}"></td>
                        ...
                        <td>
                            <form action="{{ route('panel.user-feature.destroy', $item->id) }}" method="post">
                                @csrf
                                @method('delete')
                                <button type="button" class="btn btn-outline-primary btn-sm" data-bs-toggle="modal"
                                    ...
                                    data-action="{{ route('panel.user-feature.update', $item->id) }}"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">{{ __('FsLang::panel.sidebar_expand_user_feature') }}</h5>
