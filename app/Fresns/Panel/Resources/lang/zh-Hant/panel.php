...
return [
    ...
    */
    ...
    'sidebar_expand_editor' => '編輯器擴充',
    'sidebar_expand_content_type' => '內容類型擴充',
    'sidebar_expand_post_detail' => '貼文詳情擴充',
    'sidebar_expand_manage' => '管理擴充',
    'sidebar_expand_group' => '社團擴充',
    'sidebar_expand_group_filter' => '社團篩選',
    'sidebar_expand_user_feature' => '用戶功能擴充',
    'sidebar_expand_user_profile' => '用戶資料擴充',
    ...
    'sidebar_expand_editor_intro' => '將呈現在發布流程的「編輯器」中，例如「投票」擴充可以讓「編輯器」支持為貼文附帶投票功能。',
    'sidebar_expand_content_type_intro' => '將呈現在「貼文」列表頁面中，用於輸出指定「類型」的貼文，以及定義數據結果來源。',
    'sidebar_expand_post_detail_intro' => '功能與「內容類型擴充」數據來源功能一樣，是否將請求分發給外掛處理，由外掛決定數據邏輯。',
    'sidebar_expand_manage_intro' => '將呈現在貼文、留言、用戶主頁的「更多」功能列表中，例如「投訴」擴充可以讓用戶對相應目標進行投訴。',
    'sidebar_expand_group_intro' => '將呈現在「社團」主頁中，例如「純鏈接擴充外掛」可以在「社團」主頁顯示一個超鏈接。',
    'sidebar_expand_user_feature_intro' => '將呈現在「用戶中心」的“我的”頁面中，例如「錢包」擴充可以讓用戶中心多一個錢包功能。',
    'sidebar_expand_user_profile_intro' => '將呈現在「用戶資料」管理功能列表中，例如「修改用戶名外掛」可以讓修改資料功能支持修改用戶名。',
    ...
    'support_market' => '應用市場',
    'system_info' => '系統信息',
    'system_info_fresns_version' => '主程式版本',
    'system_info_server' => '伺服器系統',
    'system_info_web' => 'Web 運行環境',
    'system_info_php' => 'PHP 版本',
    'system_info_database' => '資料庫版本',
    ...
    'default_timezone_desc' => '當用戶未自定義選擇時區時，默認以此時區顯示時間。',
    ...
    'user_multiple_service_null' => '暫停多用戶管理',
    ...
    'interactive_nearby_length' => '附近貼文默認範圍',
    'interactive_nearby_length_desc' => '範圍單位以多語言配置為準，默認是公里 km',
    ...
    'interactive_it_like_users' => 'TA 點讚的用戶',
    'interactive_it_like_groups' => 'TA 點讚的社團',
    'interactive_it_like_hashtags' => 'TA 點讚的話題',
    'interactive_it_like_posts' => 'TA 點讚的貼文',
    'interactive_it_like_comments' => 'TA 點讚的留言',
    ...
    'publish_editor_title_word_count' => '標題字數限制',
    'publish_editor_title_word_count_desc' => '標題字數不得超過設定數，最大上限 255 個字符',
    'publish_editor_post_word_count' => '貼文字數限制',
    'publish_editor_post_word_count_desc' => '貼文字數不得超過設定數，最小上限 140 個字符',
    'publish_editor_post_brief_word_count' => '貼文摘要字數',
    'publish_editor_post_brief_word_count_desc' => '貼文超過該設定值將採用摘要，超長內容摘要字數',
    'publish_editor_comment_word_count' => '留言字數限制',
    'publish_editor_comment_word_count_desc' => '留言字數不得超過設定數，最小上限 140 個字符',
    'publish_editor_comment_brief_word_count' => '留言摘要字數',
    'publish_editor_comment_brief_word_count_desc' => '留言超過該設定值將採用摘要，超長內容摘要字數',
    ...
    // Expands
    'expand_editor_number_of_uses_desc' => '以“投票”外掛舉例，數量為 2 則代表單個貼文可以附帶 2 個投票',
    'expand_content_type_option_post_all' => '貼文總列表',
    'expand_content_type_option_post_follow' => '關注對象的貼文',
    'expand_content_type_option_post_nearby' => '附近範圍的貼文',
    'expand_content_type_rank_number' => '排序編號配置',
    'expand_content_type_rank_number_desc' => '如何填寫請參見「數據來源」關聯外掛的說明文檔',
    // Client-Menus
    'menu_table_home' => '首頁',
    'menu_table_menu' => '菜單',
    'menu_table_path' => '路徑',
