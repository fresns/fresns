...
return [
    ...
    */
    ...
    'sidebar_social_intro' => '社交系統功能設定。',
    'sidebar_user_intro' => '用户基础功能设置。',
    'sidebar_content_intro' => '社交內容名稱和功能配置。',
    'sidebar_interaction_intro' => '社交互動功能配置。',
    ...
    'sidebar_extend_user_profile_intro' => '將呈現在「用戶資料」管理功能列表中，例如「修改用戶名外掛」可以讓修改資料功能支援修改用戶名。',
    ...
    'account_kyc_service_desc' => '安裝認證服務外掛後，用戶可以實名制認證。',
    // System-Wallet
    ...
    'interaction_conversation_files_desc' => '如果全部不勾選則代表只支援純文字的對話',
    ...
    'menu_table_query_state_desc' => '是否接受用戶端傳參，關閉後將僅支援默認參數值',
