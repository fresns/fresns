...
return [
    ...
    */
    ...
    'sidebar_keys' => '應用密鑰',
    // Sidebar intro
    'sidebar_admins_intro' => '有權登入控制面板的用戶',
    ...
    'sidebar_rename_intro' => '透過自定義命名改變用戶的感知，實現各種運營場景。',
    'sidebar_interaction_intro' => '基礎的互動功能配置，更多功能配置請參見網站引擎或移動應用設定頁。',
    'sidebar_stickers_intro' => '自定義配置表情圖，在不配置的情況下，用戶也可以透過表情鍵盤輸入 Emoji 表情。',
    ...
    'site_mode_public_login_or_register' => '驗證碼登入時，無賬號則自動註冊',
    ...
    'site_login' => '登入支持',
    'site_login_type_email' => '郵箱登入',
    'site_login_type_phone' => '手機號登入',
    'site_email' => '管理員郵箱',
    ...
    'user_account_connect_services_desc' => '選擇互聯平台並關聯外掛，可實現快捷註冊或登入。',
