...
return [
    ...
    */
    ...
    'cache_laravel_view' => '視圖',
    'cache_laravel_route' => '路由',
    'cache_laravel_event' => '事件',
    'cache_laravel_schedule' => '任務調度',
    'cache_laravel_config' => '框架配置',
    ...
    'interaction_top_comment_require' => '貼文熱評條件',
    'interaction_top_comment_require_desc' => '留言點贊總數達到多少開啟熱評功能，0 代表不啟用',
    'interaction_comment_visibility_rule' => '留言可見度規則',
    'interaction_comment_visibility_rule_desc' => '貼文發表時間大於天數，留言將隱藏，0 代表不啟用',
    'interaction_comment_preview' => '留言預覽數量',
    'interaction_comment_preview_desc' => '留言列表子級留言預覽，數字代表預覽數量。',
