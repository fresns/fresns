...
return [
    ...
    */
    ...
    'sidebar_menus_intro' => '統一配置使用者端菜單信息。',
    'sidebar_columns_intro' => '統一為使用者端各個欄目配置命名。',
    ...
    'user_default_role' => '默認使用者角色',
    'user_default_role_desc' => '註冊後默認使用者角色',
    'user_default_avatar' => '默認使用者頭像',
    'user_default_avatar_desc' => '使用者未設定頭像時的默認頭像圖',
    ...
    'rename_dislike_user_name' => '不喜歡使用者行為',
    ...
    'rename_follow_user_name' => '跟隨使用者行為',
    ...
    'rename_block_user_name' => '封鎖使用者行為',
    ...
    'rename_user_follower_name' => '跟隨使用者對象',
    ...
    'interaction_view_config' => '查看使用者內容設置',
    ...
    'interaction_preview_post_like_users' => '貼文點贊使用者預覽',
    'interaction_preview_post_like_users_desc' => '預覽點讚了貼文的使用者，數字代表預覽數量。',
    ...
    'interaction_it_like_users' => '他讚的使用者',
    ...
    'interaction_it_dislike_users' => '他不喜歡的使用者',
    ...
    'interaction_it_follow_users' => '他跟隨的使用者',
    ...
    'interaction_it_block_users' => '他封鎖的使用者',
    ...
    'interaction_my_likers' => '讚我的使用者',
    'interaction_my_dislikers' => '不喜歡我的使用者',
    'interaction_my_followers' => '跟隨我的使用者',
    'interaction_my_blockers' => '封鎖我的使用者',
    'interaction_my_liker_count' => '喜歡我的使用者總數',
    'interaction_my_disliker_count' => '不喜歡我的使用者總數',
    'interaction_my_follower_count' => '跟隨我的使用者總數',
    'interaction_my_blocker_count' => '封鎖我的使用者總數',
    'interaction_like_it' => '讚了他的使用者',
    'interaction_dislike_it' => '不喜歡他的使用者',
    'interaction_follow_it' => '跟隨了他的使用者',
    'interaction_block_it' => '封鎖了他的使用者',
    'interaction_like_it_count' => '喜歡了他的使用者總數',
    'interaction_dislike_it_count' => '不喜歡了他的使用者總數',
    'interaction_follow_it_count' => '跟隨了他的使用者總數',
    'interaction_block_it_count' => '封鎖了他的使用者總數',
    // Operating-Sticker
    'sticker_group' => '表情組',
    ...
    'publish_verify_desc' => '使用者必須滿足所選條件才能發表內容',
    ...
    'group_option_publish_follow' => '僅跟隨了社團的使用者',
    'group_option_publish_role' => '僅指定的角色使用者',
    ...
    'columns_profile_rename' => '使用者主頁命名',
    'menu_like_users' => '讚的使用者',
    'menu_dislike_users' => '不喜歡的使用者',
    'menu_follow_users' => '跟隨的使用者',
    'menu_block_users' => '封鎖的使用者',
    'menu_follow_user_posts' => '跟隨使用者的貼文',
    'menu_follow_user_comments' => '跟隨使用者的留言',
