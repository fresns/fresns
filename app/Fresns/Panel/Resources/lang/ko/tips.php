...
return [
    ...
    */
    ...
    'manual_upgrade_tip' => '이 업그레이드는 자동 업그레이드를 지원하지 않으므로 "물리적 업그레이드" 방법을 사용하십시오.',
    'manual_upgrade_version_guide' => '이 버전의 업데이트 설명을 읽으려면 클릭하십시오.',
    'manual_upgrade_guide' => '업그레이드 가이드',
    'manual_upgrade_file_error' => '물리적 업그레이드 파일 불일치',
    'manual_upgrade_confirm_tip' => '"업그레이드 가이드"를 읽고 가이드에 따라 파일의 새 버전을 처리했는지 확인하십시오.',
    ...
    'manualUpgrade_step_1' => '초기화 확인',
    'manualUpgrade_step_2' => '데이터 업데이트',
    'manualUpgrade_step_3' => '모든 플러그인 종속성 패키지를 설치합니다(이 단계는 느린 프로세스이므로 잠시만 기다려 주십시오).',
    'manualUpgrade_step_4' => '확장 게시 및 복원 활성화',
    'manualUpgrade_step_5' => 'Fresns 버전 정보 업데이트',
    'manualUpgrade_step_6' => '캐시를 비 웁니다',
    'manualUpgrade_step_7' => '마치다',
    // uninstall
