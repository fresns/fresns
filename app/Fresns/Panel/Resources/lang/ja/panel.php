...
return [
    ...
    */
    ...
    'sidebar_social_intro' => 'ソーシャルシステム機能設定',
    ...
    // System-Social
    'social_mention_status' => 'コメント状況',
    'social_hashtag_status' => 'ハッシュタグの状態',
    'social_hashtag_format' => 'ハッシュタグのフォーマット',
    'social_hashtag_format_1' => '単一＃号機',
    'social_hashtag_format_2' => 'ダブル＃号機',
    'social_hashtag_format_desc' => '<a href="#">＃トピック</a>と<a href="#">＃トピック＃</a>',
    'social_hashtag_length' => 'ハッシュタグの長さ',
    'social_hashtag_regexp' => 'ハッシュタグの正規表現',
    'social_conversation_status' => 'プライベートレターセッション',
    'social_conversation_status_desc' => 'CLOSEはすべてのメンバーに対して有効であり、オープニング後のユーザーロール権利の対象となります。',
    'social_conversation_files' => 'セッションアクセサリー機能',
    'social_conversation_files_desc' => 'すべてがチェックされていない場合、代表者は純粋なテキストの会話のみをサポートします',
    'social_view_config' => 'ソーシャルコンテンツ設定',
    'social_view_posts_by_timelines' => 'Timelinesの投稿を見る',
    'social_view_comments_by_timelines' => 'Timelinesのコメントを見る',
    'social_view_posts_by_nearby' => 'Nearbyの投稿を見る',
    'social_view_comments_by_nearby' => 'Nearbyのコメントを見る',
    'social_nearby_length' => '周辺検索のデフォルト範囲',
    'social_nearby_length_desc' => '周辺コンテンツ閲覧時の検索範囲',
    // System-Storage
