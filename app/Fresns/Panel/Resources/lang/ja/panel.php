...
return [
    ...
    */
    ...
    'sidebar_extend_post_detail' => '投稿詳細',
    ...
    'sidebar_extend_post_detail_intro' => 'この関数は、「コンテンツタイプ拡張機能」データソース関数と同じであり、要求がプラグイン処理に配布され、データロジックはプラグインによって決定されます。',
    ...
    'interactive_user_profile' => 'それはのホームページにアクセスするときは、デフォルトのコンテンツリストです。',
    ...
    'interactive_it_likers' => 'それはのユーザーのポイント',
    'interactive_it_dislikers' => '嫌いなもの',
    'interactive_it_followers' => 'それはユーザーに注意を払う',
    'interactive_it_blockers' => 'シールドそれはユーザー',
    ...
    'publish_editor_title_word_length' => 'タイトル単語の制限',
    'publish_editor_title_word_length_desc' => 'タイトル数は設定数を超えてはいけません、最大上限255文字',
    'publish_editor_post_word_length' => '単語の制限を投稿',
    'publish_editor_post_word_length_desc' => 'ポスト数は設定数、最小上限140文字を超えない',
    'publish_editor_post_brief_word_length' => 'ポスト要約',
    'publish_editor_post_brief_word_length_desc' => 'POSTがこの設定値を超えると、特大のコンテンツの概要の単語の概要を採用します。',
    'publish_editor_comment_word_length' => 'コメント単語の制限',
    'publish_editor_comment_word_length_desc' => 'コメント数は設定数、最小上限140文字を超えてはいけません',
    'publish_editor_comment_brief_word_length' => 'コメントの概要',
    'publish_editor_comment_brief_word_length_desc' => '設定値が概要、監督の内容の概要を採用する前にコメントする',
