...
return [
    ...
    */
    ...
    'cache_laravel_view' => '表示',
    'cache_laravel_route' => 'ルート',
    'cache_laravel_event' => 'イベント',
    'cache_laravel_schedule' => 'スケジュール',
    'cache_laravel_config' => 'フレーム構成',
    ...
    'interaction_top_comment_require' => 'ホット評価条件を投稿します',
    'interaction_top_comment_require_desc' => 'コメントポイントの合計数は、ホット評価機能が満たされていますが、0代表が有効になっていません',
    ...
    'interaction_comment_preview' => 'プレビュー数についてコメントしてください',
    'interaction_comment_preview_desc' => 'コメントリストサブレベルのコメントプレビュー、数値はプレビューの数を表します。',
