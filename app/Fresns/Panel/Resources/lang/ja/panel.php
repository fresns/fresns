...
return [
    ...
    */
    ...
    'setting_backend_domain_desc' => 'メインプログラムAPIとプラグインのデフォルトアクセスアドレス、',
    ...
    'storage_bucket_domain_desc' => 'http：//またはhttps：//のストレージ構成ドメイン名：    // /',
    ...
    'interactive_it_publish_posts' => 'TA投稿投稿',
    'interactive_it_publish_comments' => 'TAはコメントを公開しました',
    ...
    'expand_content_type_option_post_list' => '投稿の合計リスト',
    'expand_content_type_option_post_follow' => 'オブジェクトの投稿に焦点を当てる',
    'expand_content_type_option_post_nearby' => '近くの投稿',
    'expand_content_type_sort_number' => 'ソート番号設定',
    'expand_content_type_sort_number_desc' => '記入方法は、「データソース」関連プラグインの文書を参照してください。',
    // Client-Menus
    'menu_table_home' => '表紙',
