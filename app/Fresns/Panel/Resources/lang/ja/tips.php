...
return [
    ...
    */
    ...
    // dashboard
    'panel_config' => 'コンフィギュレーションを変更した後、新しいコンフィギュレーションを有効にする前に、キャッシュをクリアする必要があります。',
    'plugin_install_or_upgrade' => 'プラグインをインストールまたはアップグレードすると、デフォルトでオフになり、プラグインのエラーに起因するシステムの問題を回避するために、手動で有効にする必要があります。',
    // website
