...
return [
    ...
    */
    ...
    // dashboard
    'panel_config' => 'कॉन्फ़िगरेशन को संशोधित करने के बाद, आपको नए कॉन्फ़िगरेशन के प्रभावी होने के लिए कैश साफ़ करना होगा।',
    'plugin_install_or_upgrade' => 'प्लग-इन स्थापित या अपग्रेड किए जाने के बाद, प्लग-इन त्रुटियों के कारण होने वाली सिस्टम समस्याओं से बचने के लिए, यह डिफ़ॉल्ट रूप से अक्षम होता है और इसे मैन्युअल रूप से सक्षम करने की आवश्यकता होती है।',
    // website
    ...
    // theme
    'website_engine_error' => 'वेबसाइट इंजन स्थापित नहीं है',
