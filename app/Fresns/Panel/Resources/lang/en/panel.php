...
return [
    ...
    */
    ...
    'sidebar_extend_post_detail' => 'Post Detail',
    ...
    'sidebar_extend_post_detail_intro' => 'The function is the same as the "Content Type Extension" data source function, whether the request is distributed to the plugin for processing is up to the plugin to determine the data logic',
    ...
    'interactive_it_dislikers' => 'Dislikers',
    ...
    'publish_editor_title_word_length' => 'Title Word Limit',
    'publish_editor_title_word_length_desc' => 'The number of characters in the title must not exceed the set number, with a maximum limit of 255 characters',
    'publish_editor_post_word_length' => 'Post Word Limit',
    'publish_editor_post_word_length_desc' => 'The number of words in the post must not exceed the set number, the minimum upper limit of 140 characters',
    'publish_editor_post_brief_word_length' => 'Post Brief Word Limit',
    'publish_editor_post_brief_word_length_desc' => 'Posts exceeding this set value will use the summary, the number of words in the summary of extra-long content',
    'publish_editor_comment_word_length' => 'Comment Word Limit',
    'publish_editor_comment_word_length_desc' => 'The number of characters in the comment must not exceed the set number, with a minimum limit of 140 characters',
    'publish_editor_comment_brief_word_length' => 'Comment Brief Word Limit',
    'publish_editor_comment_brief_word_length_desc' => 'Comments exceeding this set value will be used to summarize, the number of words in the summary of extra-long content',
