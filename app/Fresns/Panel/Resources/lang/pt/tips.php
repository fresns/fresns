...
return [
    ...
    */
    ...
    'physicalUpgrade_step_1' => 'Verificação de inicialização',
    'physicalUpgrade_step_2' => 'Actualização de dados',
    'physicalUpgrade_step_3' => 'Instalar todos os pacotes de dependência de plugin (este passo é um processo lento, por favor seja paciente)',
    'physicalUpgrade_step_4' => 'Publicar e restaurar extensões activadas',
    'physicalUpgrade_step_5' => 'Actualização de informação da versão Fresns',
    'physicalUpgrade_step_6' => 'Esvaziar o cache',
    'physicalUpgrade_step_7' => 'Terminar',
    // uninstall
