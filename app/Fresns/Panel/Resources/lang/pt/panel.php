...
return [
    ...
    */
    ...
    'sidebar_extend_post_detail' => 'Post detalhe',
    ...
    'sidebar_extend_post_detail_intro' => 'A função é a mesma que a função de fonte de dados "Extensão do tipo de conteúdo", se a solicitação é distribuída no processamento do plugin e a lógica de dados é determinada pelo plugin',
    ...
    'interactive_user_profile' => 'Ao acessar a página inicial do É, a lista de conteúdo padrão',
    ...
    'interactive_it_likers' => 'Pontos dos usuários de É',
    'interactive_it_dislikers' => 'Não gosta',
    'interactive_it_followers' => 'Preste atenção aos usuários do É',
    ...
    'publish_editor_title_word_length' => 'Limite de palavra de título',
    'publish_editor_title_word_length_desc' => 'O número de títulos não deve exceder o número de configurações, o limite máximo de limite superior 255',
    'publish_editor_post_word_length' => 'Postar limite de palavras',
    'publish_editor_post_word_length_desc' => 'O número de postagens não excederá o número de configurações, limite superior mínimo de 140 caracteres',
    'publish_editor_post_brief_word_length' => 'Post abstrato',
    'publish_editor_post_brief_word_length_desc' => 'O post excede esse valor definido adotará um resumo, o número de palavras de resumo de conteúdo superdimensionadas',
    'publish_editor_comment_word_length' => 'Limite de palavras de comentários',
    'publish_editor_comment_word_length_desc' => 'O número de comentários não deve exceder o número de configurações, limite máximo de limite superior 140',
    'publish_editor_comment_brief_word_length' => 'Resumo do comentário',
    'publish_editor_comment_brief_word_length_desc' => 'Comentário antes que o valor definido adote um resumo, supervisione o resumo de conteúdo de comprimento',
