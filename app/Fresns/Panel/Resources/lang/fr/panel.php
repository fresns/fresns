...
return [
    ...
    */
    ...
    'sidebar_extend_post_detail' => 'Détail',
    ...
    'sidebar_extend_post_detail_intro' => 'La fonction est la même que la fonction de source de données "Type de contenu", si la demande est distribuée au traitement du plugin et la logique de données est déterminée par le plugin',
    ...
    'interactive_user_profile' => 'Lors de l\'accès à la page d\'accueil de Il, la liste de contenu par défaut',
    ...
    'interactive_it_likers' => 'Points des utilisateurs de Il',
    'interactive_it_dislikers' => 'N\'aime pas',
    'interactive_it_followers' => 'Faites attention aux utilisateurs de Il',
    'interactive_it_blockers' => 'Bouclier Il User',
    ...
    'publish_editor_title_word_length' => 'Limite de mot de titre',
    'publish_editor_title_word_length_desc' => 'Le nombre de titres ne doit pas dépasser le nombre de paramètres, la limite supérieure maximale de 255 caractères',
    'publish_editor_post_word_length' => 'Limite d\'affichage',
    'publish_editor_post_word_length_desc' => 'Le nombre de postes ne dépassera pas le nombre de réglages, une limite supérieure minimale de 140 caractères',
    'publish_editor_post_brief_word_length' => 'Post-résumé',
    'publish_editor_post_brief_word_length_desc' => 'Le poste dépasse cette valeur définie adoptera un résumé, le nombre de mots de résumé de contenu surdimensionné',
    'publish_editor_comment_word_length' => 'Limite de mot de commentaire',
    'publish_editor_comment_word_length_desc' => 'Le nombre de commentaires ne doit pas dépasser le nombre de paramètres, minimum limite supérieure de 140 caractères',
    'publish_editor_comment_brief_word_length' => 'Résumé des commentaires',
    'publish_editor_comment_brief_word_length_desc' => 'Commentaire Avant que la valeur définie adoptera un résumé du contenu de la longueur de la longueur de la supervision',
