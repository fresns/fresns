...
return [
    ...
    */
    ...
    'deleteSuccess' => 'Supprimer un succès',
    'updateSuccess' => 'Mettre à jour le succès',
    'upgradeSuccess' => 'Upgrade Success',
    'installSuccess' => 'Installer avec succès',
    'uninstallSuccess' => 'Désinstallation réussie',

    'createFailure' => 'Créer Échec',
    'deleteFailure' => 'Échec de la suppression',
    'updateFailure' => 'Échec de la mise à jour',
    'upgradeFailure' => 'Échec de la mise à niveau',
    'installFailure' => 'Échec de l\'installation',
    'downloadFailure' => 'Télécharger l\'échec',
    ...
    'manual_upgrade_tip' => 'Cette mise à jour ne prend pas en charge la mise à niveau automatique, veuillez utiliser la méthode de "mise à niveau physique".',
    'manual_upgrade_version_guide' => 'Cliquez pour lire les instructions de cette mise à jour',
    'manual_upgrade_guide' => 'Guide de mise à niveau',
    'manual_upgrade_file_error' => 'Mauvaise concordance du fichier de mise à niveau physique',
    'manual_upgrade_confirm_tip' => 'Veuillez vous assurer que vous avez lu le "Guide de mise à niveau" et que vous avez traité la nouvelle version du fichier conformément au guide.',
    ...
    'manualUpgrade_step_1' => 'Vérification d\'initialisation',
    'manualUpgrade_step_2' => 'Mise à jour des données',
    'manualUpgrade_step_3' => 'Installer tous les paquets de dépendance des plugins (cette étape est un processus lent, veuillez être patient)',
    'manualUpgrade_step_4' => 'Publier et restaurer l\'activation des extensions',
    'manualUpgrade_step_5' => 'Mettre à jour les informations sur la version de Fresns',
    'manualUpgrade_step_6' => 'Vider le cache',
    'manualUpgrade_step_7' => 'Finir',
    // uninstall
    ...
    // theme
    'website_engine_error' => 'Le moteur de site web n\'est pas installé',
