...
return [
    ...
    */
    ...
    'sidebar_expand_editor' => '编辑器扩展',
    'sidebar_expand_content_type' => '内容类型扩展',
    'sidebar_expand_post_detail' => '帖子详情扩展',
    'sidebar_expand_manage' => '管理扩展',
    'sidebar_expand_group' => '小组扩展',
    'sidebar_expand_group_filter' => '小组筛选',
    'sidebar_expand_user_feature' => '用户功能扩展',
    'sidebar_expand_user_profile' => '用户资料扩展',
    ...
    'sidebar_expand_editor_intro' => '将呈现在发布流程的「编辑器」中，例如「投票」扩展可以让「编辑器」支持为帖子附带投票功能。',
    'sidebar_expand_content_type_intro' => '将呈现在「帖子」列表页面中，用于输出指定「类型」的帖子，以及定义数据结果来源。',
    'sidebar_expand_post_detail_intro' => '功能与「内容类型扩展」数据来源功能一样，是否将请求分发给插件处理，由插件决定数据逻辑。',
    'sidebar_expand_manage_intro' => '将呈现在帖子、评论、用户主页的「更多」功能列表中，例如「投诉」扩展可以让用户对相应目标进行投诉。',
    'sidebar_expand_group_intro' => '将呈现在「小组」主页中，例如「纯链接扩展插件」可以在「小组」主页显示一个超链接。',
    'sidebar_expand_user_feature_intro' => '将呈现在「用户中心」的“我的”页面中，例如「钱包」扩展可以让用户中心多一个钱包功能。',
    'sidebar_expand_user_profile_intro' => '将呈现在「用户资料」管理功能列表中，例如「修改用户名插件」可以让修改资料功能支持修改用户名。',
    ...
    'sidebar_website_engines_intro' => '选用不同的引擎，实现更个性化的功能和服务。',
    'sidebar_website_themes_intro' => '选用不同的主题，实现更个性化的风格和交互。',
    'sidebar_apps_intro' => '选装不同的应用程序，创造不一样的运营场景和应用模式。',
    // Page button
    'button_support' => '帮助说明',
    'button_upgrade' => '更新',
    'button_search' => '搜索',
    ...
    'extensions' => '应用数量',
    'extensions_admins' => '管理员',
    'extensions_keys' => '接口密钥',
    'extensions_plugins' => '扩展插件',
    'extensions_engines' => '网站引擎',
    'extensions_themes' => '主题模板',
    'extensions_apps' => '移动应用',
    'support' => '帮助手册',
    ...
    // Dashboard-Settings
    'setting_backend_domain' => '后端网址',
    'setting_backend_domain_desc' => '主程序 API 和插件默认访问地址',
    ...
    'default_timezone_desc' => '当用户未自定义选择时区时，默认以此时区显示时间。',
    ...
    'send_android_desc' => 'Android 系统弹窗通知功能。',
    'send_wechat_config' => '微信配置',
    'send_wechat_desc' => '微信服务通知或者公众号模板消息。',
    ...
    'user_multiple_service_null' => '暂停多用户管理',
    ...
    'interactive_view_config' => '查看别人内容设置',
    ...
    'interactive_comment_preview_desc' => '评论列表子级评论预览，0 代表不启用，最大数字 3',
    'interactive_nearby_length' => '附近帖子默认范围',
    'interactive_nearby_length_desc' => '范围单位以多语言配置为准，默认是公里 km',
    ...
    'interactive_view_content' => '哪些内容可以被别人查看？',
    'interactive_user_profile' => '访问 TA 的主页时，默认内容列表',
    ...
    'interactive_it_likers' => '点赞 TA 的用户',
    'interactive_it_followers' => '关注 TA 的用户',
    'interactive_it_blockers' => '屏蔽 TA 的用户',
    ...
    'publish_editor_title_word_count' => '标题字数限制',
    'publish_editor_title_word_count_desc' => '标题字数不得超过设置数，最大上限 255 个字符',
    'publish_editor_post_word_count' => '帖子字数限制',
    'publish_editor_post_word_count_desc' => '帖子字数不得超过设置数，最小上限 140 个字符',
    'publish_editor_post_brief_word_count' => '帖子摘要字数',
    'publish_editor_post_brief_word_count_desc' => '帖子超过该设定值将采用摘要，超长内容摘要字数',
    'publish_editor_comment_word_count' => '评论字数限制',
    'publish_editor_comment_word_count_desc' => '评论字数不得超过设置数，最小上限 140 个字符',
    'publish_editor_comment_brief_word_count' => '评论摘要字数',
    'publish_editor_comment_brief_word_count_desc' => '评论超过该设定值将采用摘要，超长内容摘要字数',
    ...
    // Expands
    'expand_editor_number_of_uses_desc' => '以“投票”插件举例，数量为 2 则代表单个帖子可以附带 2 个投票',
    'expand_content_type_option_post_all' => '帖子总列表',
    'expand_content_type_option_post_follow' => '关注对象的帖子',
    'expand_content_type_option_post_nearby' => '附近范围的帖子',
    'expand_content_type_rank_number' => '排序编号配置',
    'expand_content_type_rank_number_desc' => '如何填写请参见「数据来源」关联插件的说明文档',
    // Client-Menus
    'menu_table_home' => '首页',
    'menu_table_menu' => '菜单',
    'menu_table_path' => '路径',
    ...
    'menu_post_from_follow_users' => '关注用户的帖子',
    'menu_comment_from_follow_users' => '关注用户的评论',
    'menu_like_groups' => '点赞的小组',
    'menu_follow_groups' => '关注的小组',
    'menu_block_groups' => '屏蔽的小组',
    'menu_post_from_follow_groups' => '关注小组的帖子',
    'menu_comment_from_follow_groups' => '关注小组的评论',
    'menu_like_hashtags' => '点赞的话题',
    'menu_follow_hashtags' => '关注的话题',
    'menu_block_hashtags' => '屏蔽的话题',
    'menu_post_from_follow_hashtags' => '关注话题的帖子',
    'menu_comment_from_follow_hashtags' => '关注话题的评论',
    'menu_like_posts' => '点赞的帖子',
    'menu_follow_posts' => '关注的帖子',
    'menu_block_posts' => '屏蔽的帖子',
    'menu_post_from_follow_all' => '全部关注的帖子',
    'menu_post_from_nearby' => '附近范围的帖子',
    'menu_post_from_location' => '指定位置的周边帖子',
