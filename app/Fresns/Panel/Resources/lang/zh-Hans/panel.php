...
return [
    ...
    */
    ...
    'setting_backend_domain_desc' => '主程序 API 和插件默认访问地址，结尾不带 /',
    ...
    'storage_bucket_domain_desc' => '存储配置域名以 http:// 或 https:// 开头，结尾不带 /',
    'storage_ext' => '支持的扩展名',
    ...
    'interactive_it_publish_posts' => 'TA 发表的帖子',
    'interactive_it_publish_comments' => 'TA 发表的评论',
    ...
    'expand_content_type_option_post_list' => '帖子总列表',
    'expand_content_type_option_post_follow' => '关注对象的帖子',
    'expand_content_type_option_post_nearby' => '附近范围的帖子',
    'expand_content_type_sort_number' => '排序编号配置',
    'expand_content_type_sort_number_desc' => '如何填写请参见「数据来源」关联插件的说明文档',
    // Client-Menus
    'menu_table_home' => '首页',
    'menu_table_menu' => '菜单',
    'menu_table_path' => '路径',
