...
return [
    ...
    */
    ...
    'physical_upgrade_step_1' => '初始化验证',
    'physical_upgrade_step_2' => '更新数据',
    'physical_upgrade_step_3' => '安装所有插件依赖包（该步骤流程较慢，请耐心等待）',
    'physical_upgrade_step_4' => '发布并恢复扩展启用',
    'physical_upgrade_step_5' => '更新 Fresns 版本信息',
    'physical_upgrade_step_6' => '清理缓存',
    'physical_upgrade_step_7' => '完成',
    // uninstall
