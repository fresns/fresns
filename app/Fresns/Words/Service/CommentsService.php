...
use App\Fresns\Api\Http\FsDb\FresnsCommentAppends\FresnsCommentAppendsConfig;
use App\Fresns\Api\Http\FsDb\FresnsCommentLogs\FresnsCommentLogs;
use App\Fresns\Api\Http\FsDb\FresnsComments\FresnsComments;
use App\Fresns\Api\Http\FsDb\FresnsDomainLinks\FresnsDomainLinks;
use App\Fresns\Api\Http\FsDb\FresnsDomainLinks\FresnsDomainLinksConfig;
use App\Fresns\Api\Http\FsDb\FresnsDomains\FresnsDomains;
use App\Fresns\Api\Http\FsDb\FresnsExtendLinkeds\FresnsExtendLinkedsConfig;
use App\Fresns\Api\Http\FsDb\FresnsExtends\FresnsExtends;
use App\Fresns\Api\Http\FsDb\FresnsFiles\FresnsFiles;
use App\Fresns\Api\Http\FsDb\FresnsHashtagLinkeds\FresnsHashtagLinkeds;
use App\Fresns\Api\Http\FsDb\FresnsHashtagLinkeds\FresnsHashtagLinkedsConfig;
use App\Fresns\Api\Http\FsDb\FresnsHashtags\FresnsHashtags;
use App\Fresns\Api\Http\FsDb\FresnsMembers\FresnsMembers;
use App\Fresns\Api\Http\FsDb\FresnsMembers\FresnsMembersConfig;
use App\Fresns\Api\Http\FsDb\FresnsMemberStats\FresnsMemberStats;
use App\Fresns\Api\Http\FsDb\FresnsPosts\FresnsPosts;
use App\Fresns\Api\Http\FsDb\FresnsPosts\FresnsPostsService;
use App\Fresns\Api\Http\FsDb\FresnsSessionLogs\FresnsSessionLogs;
use App\Fresns\Api\Http\FsDb\FresnsStopWords\FresnsStopWords;
use Illuminate\Support\Facades\DB;
use Illuminate\Support\Str;

class CommentsService extends FsService
{
