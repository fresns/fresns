...
class VerifyAccountDTO extends DTO
{
    public function rules(): array
    {
        return [
            ...
            'account' => ['nullable', 'required_if:type,1,2,3'], // aid, email or integer
            ...
            'connectPlatformId' => ['integer', 'nullable', 'required_without_all:verifyCode,password', 'required_if:type,4'],
            'connectAccountId' => ['string', 'nullable', 'required_without_all:verifyCode,password', 'required_if:type,4'],
        ];
    }
}
