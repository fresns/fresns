...
return [
    ...
    */
    ...
    'database_name_sqlite' => 'Путь к базе данных',
    ...
    'database_port_mysql_desc' => 'Порт по умолчанию 3306',
    'database_port_pgsql_desc' => 'Порт по умолчанию 5432',
    'database_port_sqlsrv_desc' => 'Порт по умолчанию 1433',
    ...
    // install
    'install_failure' => 'Установка не удалась, пожалуйста, проверьте журнал для выяснения причины',
    // register
