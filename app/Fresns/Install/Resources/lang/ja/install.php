...
return [
    ...
    */
    ...
    'database_driver' => 'データベース',
    'database_name' => 'データベース名',
    'database_name_sqlite' => 'データベースパス',
    ...
    'database_port_mysql_desc' => 'デフォルトのポート 3306',
    'database_port_pgsql_desc' => 'デフォルトのポート 5432',
    'database_port_sqlsrv_desc' => 'デフォルトのポート 1433',
    'database_timezone' => 'データベースタイムゾーン',
    'database_timezone_desc' => '正しく設定することで、Fresnsが正しく時刻を処理できるよう、データの時刻が正確になります。',
