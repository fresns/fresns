...
trait UserServiceTrait
{
    public function getUserProfile(): array
    {
        ...
        $profile['registerDateTime'] = $userData->created_at;
        $profile['lastPublishPostDateTime'] = $userData->last_post_at;
        $profile['lastPublishPostTimeAgo'] = null;
        $profile['lastPublishCommentDateTime'] = $userData->last_comment_at;
        $profile['lastPublishCommentTimeAgo'] = null;
        $profile['lastEditUsernameDateTime'] = $userData->last_username_at;
        $profile['lastEditNicknameDateTime'] = $userData->last_nickname_at;
